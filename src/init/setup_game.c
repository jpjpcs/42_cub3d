...
/*   Updated: 2024/11/20 16:03:01 by joaosilva        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void setup_game(t_game *game)
{
    ...
    game->player.pos_x = 2.0; // Posição inicial do jogador no eixo X
    game->player.pos_y = 2.0; // Posição inicial do jogador no eixo Y
