...
/*   Updated: 2024/11/21 18:36:33 by jode-jes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void setup_game(t_game *game)
{
    ...
    game->player.current.pos_x = 2.0; // Posição inicial do jogador no eixo X
    game->player.current.pos_y = 2.0; // Posição inicial do jogador no eixo Y
